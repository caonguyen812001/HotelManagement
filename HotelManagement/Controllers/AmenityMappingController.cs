...
{
    public class AmenityMappingController : Controller
    {
        private readonly HotelManagementContext _context;

        public AmenityMappingController(HotelManagementContext context)
        {
            _context = context;
        }
        ...
        // GET: AmenityMapping/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: AmenityMapping/Create
