...
namespace HotelManagement.Controllers
{
    public class RoomTypeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,NumberOfBed,NumberOfRoom,ImageUrlsJsonString,PricePerNight")] RoomType roomType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Name,Description,NumberOfBed,NumberOfRoom,ImageUrlsJsonString,PricePerNight")] RoomType roomType)
        {
            if (id != roomType.Id)
            {
                return NotFound();
